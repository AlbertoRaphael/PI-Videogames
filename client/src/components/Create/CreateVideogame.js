...
import { createVideogame, getByGenres,getPlatforms  } from "../Redux/action/index";
...
export default function Create() {
  ...
  return (
    <div>
      <form onSubmit={(e) => handleSubmit(e)} className={s.box_form} method ="post" action="/form" autoComplete="off">
